...
func _ready() -> void:
	...
	for track in ["easy", "medium", "hard", "EVO"]:
...
func start_demo() -> void:
	...
	match selected_mode:
		DEMO_MODE.training:
			...
			var car_main = load("res://demos/boogers/CarMain.tscn").instance()
		...
		DEMO_MODE.race:
			...
			var car_race_main = load("res://demos/boogers/race_mode/CarRaceMain.tscn").instance()
